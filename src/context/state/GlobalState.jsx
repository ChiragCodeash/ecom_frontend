...
import { AuthContext, GlobalContext } from "../CreateContext";

const GlobalState = ({ children }) => {
  const profile_url = `${import.meta.env.VITE_APP_SERVER_URL}/profile`;
  ...
  const GetState = () =>{
    return Object.keys(stateAndCity)
  }
  const GetCity = (state) =>{
    return stateAndCity[state]
  }
  ...
  const DefaultObj = {
    ...
    showGlobalLoading,
    user,
    setUser,GetCity , GetState , loading , setLoading
  };
  return (
