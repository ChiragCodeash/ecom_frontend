          ...
          <div className="product-card mb-3 mb-md-4 mb-xxl-5">
            <div className="pc__img-wrapper">
              <div style={{ width: 330 }} role="group">
                <Link to={`/product/${data?.variant_id}`}>
                  {data?.image_array.slice(0, 2).map((item, i,arr) => {
                    return (
                      <img
                        key={i}
                        loading="lazy"
                        ...
                        className={`pc__img ${arr.length == 2 && i ==1  ? "pc__img-second" : ""}`}
                        // className={`pc__img `}
                      />
                    );
                  })}
            ...
            <div className="pc__info position-relative">
              <div className="d-flex flex-wrap justify-content-between">
                <p className="pc__category gclass-text">
                  {data?.category_name}
                </p>
                <p className="pc__category gclass-text">
                  <strong>{data?.total_variant}</strong> Variant
                </p>
              </div>
              <h6 className="pc__title">
                <Link to="/product" className="gclass-text-dark">
              ...
              <div className="product-card__price d-flex flex-wrap">
                <span className="money price price-old">
                  {RUPEE_SYMBOL} {data?.price}
                </span>
                <span className="money price price-sale">
                  {RUPEE_SYMBOL} {data?.sale_price}
                </span>
              </div>
